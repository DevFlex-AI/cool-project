...
/**
 * Default PearAI model options shown in the UI when users haven't configured their own.
 * Updated 2025: reflects current best models across all providers.
 */
export const FREE_TRIAL_MODELS: ModelDescription[] = [
  ...
  {
    title: "Gemini 2.0 Flash (Free Trial)",
    provider: "free-trial",
  ...
  {
    title: "Llama 3.3 70b (Free Trial)",
    provider: "free-trial",
    model: "llama-3.3-70b",
    systemMessage:
      "You are an expert software developer. You give helpful and concise responses. Whenever you write a code block you include the language after the opening ticks.",
